...
1. **Phân tích trước (Priori Analysis)**: Phân tích lý thuyết.
...
2. **Phân tích sau (Posterior Analysis)**: Phân tích thực tiễn
...
- Két quả: Số liệu về thao toán chạy thuật toán hoặc thời gian chạy của những phép tính trong thuật toán. Ta có thể xác định thời gian chạy của một phép tính dựa trên số chỉ thị được thực hiện trên mỗi phép tinhs.
...
<ul>
    ...
    <li>Algorithm: Giả sử có 2 số m và n, m > n <br>
        ...
        Step 2: Nếu <b>r</b>=0, algoritm kết thúc, <b>n</b> là GCD
...
|------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| Sau khi sắp xếp, thuật toán KHÔNG thay đổi trình tự hiển thị của nội dung đó | Sau khi sắp xếp, thuật tóa thay đổi trình tự hiển thị của nội dung đó |
...
![Selection sort](../../public/img/dsaposts/sortSelection.png)
```c
...
![Bubble Sort](../../public/img/dsaposts/sortBubble.png)
```c
...
![Insertion Sort](../../public/img/dsaposts/sortInsertion.png)
```c

...
![Selection sort](https://github.com/LisaTheTechnologue/jolisablog/blob/gh-pages/_posts/it/img/sortSelection.png)   
...
![Bubble Sort](https://github.com/LisaTheTechnologue/jolisablog/blob/gh-pages/_posts/it/img/sortBubble.png)        
```c
...
![Insertion Sort](https://github.com/LisaTheTechnologue/jolisablog/blob/gh-pages/_posts/it/img/sortInsertion.png)        
```c

...
<div >
<img class="post-image" alt="Selection Sort" src="https://github.com/LisaTheTechnologue/jolisablog/blob/gh-pages/_posts/it/img/sortSelection.png">
</div>
```c
...
<div >
<img class="post-image" alt="Bubble Sort" src="https://github.com/LisaTheTechnologue/jolisablog/blob/gh-pages/_posts/it/img/sortBubble.png">
</div>         
```c
...
<div >
<img class="post-image" alt="Insertion Sort" src="https://github.com/LisaTheTechnologue/jolisablog/blob/gh-pages/_posts/it/img/sortInsertion.png">
</div>        
```c
